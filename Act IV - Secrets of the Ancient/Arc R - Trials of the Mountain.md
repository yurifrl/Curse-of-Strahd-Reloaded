...
Whether Vargas is present or not, and whether he dies or flees, continue:^[Dialogue and scene inspired by *Shadows of the Vampire * by Jim Zub, Nelson Daniel, Glauber Matos, Joana Lafuente, and Neil Uyetake (IDW Publishing, Aug. 2016).]
...
|-----------------|-------------------|
| <span class="citation">E4. Burgomaster's Mansion (p. 44)</span> | Strahd uses [[ Bat]], followed by [[ Visitor]] and [[ Storm]]. |
| <span class="citation">E5. Church (p. 45)</span> | Strahd uses [[ Bat]], followed by [[ Swarm]], [[ Visitor]], [[ Command]], and [[ Storm]]. |
| <span class="citation">N1. St. Andral's Church (p. 97)</span> | Strahd uses [[ Storm]]. |
| <span class="citation">N2. Blue Water Inn (p. 98)</span> | Strahd uses [[ Bat]]. If he succeeds, Strahd then uses [[ Visitor]]. Otherwise, Strahd then uses [[ Swarm]], followed by [[ Visitor]] and [[ Storm]]. |
| <span class="citation">N3. Burgomaster's Mansion (p. 103)</span> | Strahd uses [[ Bat]]. If he succeeds, Strahd then uses [[ Visitor]]. Otherwise, Strahd then uses [[ Swarm]], followed by [[ Visitor]] and [[ Storm]]. |
| <span class="citation">N4. Wachterhaus (p. 110)</span> | Strahd uses [[ Bat]]. If he succeeds, Strahd then uses [[ Visitor]]. Otherwise, Strahd then uses [[ Swarm]], followed by [[ Visitor]] and [[ Storm]]. |
| <span class="citation">N9. Vistani Camp (p. 119)</span> | Strahd uses [[ Visitor]], followed by [[ Storm]]. |
| <span class="citation">Chapter 6: Old Bonegrinder (p. 125)</span> | Strahd uses [[ Bat]], followed by [[ Visitor]] and [[ Storm]]. |
| <span class="citation">Chapter 7: Argynvostholt (p. 129)</span> | Strahd uses [[ Hostage]]. |
| <span class="citation">S3. Village of Krezk (p. 145)</span> | Strahd uses [[ Bat]]. If he succeeds, Strahd then uses [[ Visitor]]. Otherwise, Strahd then uses [[ Storm]]. |
| <span class="citation">S19. Barracks (p. 154)</span> | Strahd uses [[ Visitor]], followed by [[ Storm]]. |
| <span class="citation">T4-5. Guard Tower, Ground/Upper Floor (pp. 157-59)</span> | Strahd uses [[ Hostage]]. |
| <span class="citation">Chapter 11: Van Richten's Tower (p. 167)</span> | Strahd uses [[ Visitor]], followed by [[ Horde]]. |
| <span class="citation">Chapter 12: The Wizard of Wines (p. 173)</span> | Strahd uses [[ Swarm]], followed by [[ Visitor]] and [[ Storm]]. |
| <span class="citation">Chapter 15: Werewolf Den (p. 201)</span> | Strahd uses [[ Hostage]]. |
#### The Hostage
...
Each time a zombie attempts and fails to break down the door, a bolt of lightning blasts out from the door as described in [[RPG/Curse Of Strahd/Resources/Curse-of-Strahd-Reloaded/Act II - The Shadowed Town/Arc E - The Missing Vistana. The Tower Door|Arc E - The Missing Vistana]]. Each time this occurs, the tower responds as follows:
...
If the players open the door, combat ends. Proceed to [[ Visitor]] below. If the players ignore the door, continue attacking the wights and rats, or refuse Strahd entry, combat resumes, ending only when all wights and rats have been slain.
...
>
> Once Strahd has drained a player, remember that the target’s maximum hit points recover at a rate of one hit die per night. (See Strahd’s [Vampire statblock](https://www.strahdreloaded.com/Chapter+2+-+The+Land+of+Barovia/Strahd+von+Zarovich+Vampire) for more information.)
>
...
>
> Cassius and Deirdre still linger in this cave today, each having claimed a separate chamber as their "nest." Though the natural chimney in [[ Trash Heap]] connects their cavern to [[#R4k. The Ice Caves]], the **shoosuva** that dwells there is too large to descend the chimney to the bodaks’ cave, while the bodaks have no interest in contesting the shoosuva’s territory.
>
...
> When dormant, the bodak that was once Cassius dwells in [[ Western Nest]], while the bodak that was once Deirdre dwells in [[ Room of Regret]].
>
...
> * When the players first enter[[ Junction]], Cassius peers into [[ Trash Heap]], while Deirdre enters [[ Amber Shrine]].
> * If the players proceed to [[ Room of Regret]] or [[ Trash Heap]], Cassius returns to [[ Western Nest]] and Deirdre enters [[ Junction]], cutting off the players’ exit. If the players then attempt to ascend [[ Trash Heap]], the bodaks attack. Otherwise, if the players subsequently proceed to [[ Western Nest]], Cassius retreats to [[ Room of Regret]], while Deirdre advances to [[ Trash Heap]].
> * If the players proceed to [[ Amber Shrine]], Deirdre returns to [[ Eastern Nest]] and Cassius enters [[ Junction]], cutting off the players’ exit. If the players subsequently proceed to [[ Eastern Nest]], Deirdre retreats to [[ Room of Regret]], while Cassius advances to [[ Amber Shrine]].
>
> No matter what, the bodaks activate their ***auras of annihilation*** if the players (1) enter [[ Western Nest]], (2) enter [[ Eastern Nest]], or (3) attempt to ascend [[ Trash Heap]]. (See **Fighting the Bodaks** below for more information.)
>
...
>
> If the bodaks corner the players while active (i.e., after the players have entered [[ Eastern Nest]] or [[ Western Nest]], or as the players first attempt to ascend the chimney in [[ Trash Heap]]), each bodak quietly activates its ***aura of annihilation*** from a separate adjacent room and waits for the players to die. (Because a bodak’s ***aura of annihilation*** is an aura, rather than a spell or attack, the damage dealt by the aura spreads around corners.) 
>
...
The western path leads to [[ Trash Heap]], the eastern path leads to [[ Amber Shrine]], and the southern path leads to [[ Room of Regret]]. Each tunnel curves out of sight, obscuring whatever lies beyond.

![[The Bodak Cave.png]]

If the bodaks are active when the players enter this area, a player with a passive Wisdom (Perception) score of 16 or greater notices a silhouette briefly flicker across the wall of the eastern tunnel (leading to [[ Amber Shrine]]). (The silhouette belongs to Deirdre, who has vacated [[ Eastern Nest]] to investigate the newcomers. If the players approach the eastern tunnel, Deirdre exits [[ Amber Shrine]] and returns to [[ Eastern Nest]].)
...
The tunnel to the left leads to [[ Western Nest]]. The chimney, which is two-and-a-half feet in diameter, begins ten feet above the floor before rising sixty feet through the stone to [[#R4k. The Ice Caves]]. 
...
> If the full party enters this room while the bodaks are active, Cassius is lurking in [[ Western Nest]], while Deirdre attempts to sneak behind the players via [[ Junction]]. Otherwise, if the players alert the bodaks while in this room (e.g., by stepping on the bones), Cassius moves to [[ Western Nest]] while Deirdre moves to [[ Amber Shrine]], followed by [[ Junction]].
>
...
> [!info]+ **Where Are the Bodaks?**
> If the full party enters this room while the bodaks are active, Cassius is lurking in [[ Western Nest]], while Deirdre attempts to sneak behind the players via [[ Junction]]. Otherwise, if the players alert the bodaks while within this room (i.e., by disturbing or attacking Cassius), Deirdre enters combat the following round from [[ Eastern Nest]].
### The Amber Shrine
When the players enter this room, read:
...
The tunnel leads to [[ Eastern Nest]].
...
> [!info]+ **Where Are the Bodaks?**
> If the full party enters this room while the bodaks are active, Deirdre is lurking in [[ Eastern Nest]], while Cassius attempts to sneak behind the players via [[ Junction]].
### The Western Nest
...
If the players entered this chamber via [[ Trash Heap]], add:

<div class="description">
<p>A dark, narrow tunnel branches off from the left side of this chamber.</p>
</div>

This tunnel leads to [[ Room of Regret]].

Otherwise, if the players entered it via [[ Room of Regret]], add:

<div class="description">
<p>A dark, narrow tunnel branches off from the right side of this chamber.</p>
</div>

This tunnel leads to [[ Trash Heap]].
...
If the players entered this chamber via [[ Amber Shrine]], add:
...
## R4k. The Ice Caves
A player who fully ascends the natural chimney in [[ Trash Heap]] emerges into a system of ice caves. Read:
...
The western gap leads to [[ Cave of Daggers]]. A player who inspects the gap notices a shaft of pale, cold light illuminating one of the walls inside.

The northern opening, which is tall enough to admit a Small or smaller creature, or a Medium creature crawling, leads to [[ Frozen Vault]].
...
# R5. Soldav
## R5a. The Twin Falls
If the players exit [[#R4k. The Ice Caves]] via [[ Cave of Daggers]], read:
...
> Exploration of the plateau’s eastern perimeter reveals a hidden, narrow, switchback path that leads toward the mountain’s southern peak. If the players find this path, proceed to [[ Amber-Touched]]. 
...
<div class="description">
<p>Burebis’s old eyes trace across your forms, eventually coming to rest upon &;&;&;&;&;&;&;&;&;&;. "I sense the feel of the Seeker’s magic upon you," he says. "You carry a boon of the ravens, do you not?"</p>
</div>
